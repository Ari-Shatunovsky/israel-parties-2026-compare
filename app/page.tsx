          ...
          <TabsContent value="method">
            <section className="method-grid">
              ...
              <div className="method-card method-card-wide">
                ...
                <p>
                  <b>Расстояние между ступенями не утверждается.</b> Позиция считается из порядкового
                  номера, поэтому промежутки выходят равными — это свойство арифметики, а не заявление
                  о том, что одна позиция «вдвое дальше» другой.
                </p>
                <p>
                  <b>То, что ось нарисована слева направо, ничего не значит.</b> Ничего никуда не
                  складывается: каждая строка читается сама по себе, и если перевернуть любую из них,
                  в данных не изменится ни одно число. Оси намеренно не смотрят в одну сторону: на
                  одних «дальний» конец — то, что ближе правому избирателю, на других — левому.
                  Поэтому «все точки справа» не значит ничего, и ни один из шести списков не стоит у
                  одного полюса по всем осям.
                </p>
                <p>
                  По той же причине здесь нет радара. Главное, что глаз считывает с него, — площадь
                  фигуры, а площадь тут складывает несопоставимые оси. Хуже того: список, про который
                  мы меньше нашли, рисовал бы фигуру поменьше — и пробел в исследовании выглядел бы
